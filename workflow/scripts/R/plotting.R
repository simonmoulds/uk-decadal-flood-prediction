...
plot_grl2023_fig2a <- function(x, legend_title = "MSSS") {
  rdbu_pal = RColorBrewer::brewer.pal(12, "RdBu")
  p =
    ggplot() +
    geom_sf(
...
plot_grl2023_fig2c <- function(x, legend_title = "MSSS") {
  x_median <-
    x %>%
...
plot_grl2023_fig2d <- function(x, legend_title = "MSSS") {
  x_median <-
    x %>%
    group_by(model) %>%
...
plot_grl2023_fig3_map <- function(x) {
  p =
    ggplot() +
    geom_sf(
      data = europe_boundary,
...
plot_grl2023_figS1a_d <- function(x, var) {
  rdbu_pal = RColorBrewer::brewer.pal(9, "RdBu")
  p =
    ggplot() +
    geom_sf(
...
plot_grl2023_figS3a <- function(full_fcst, ensemble_fcst) {
...
plot_grl2023_figS3b <- function(full_fcst, ensemble_fcst) {
...
plot_grl2023_figS3c <- function(full_fcst, ensemble_fcst) {
...
plot_grl2023_figS3d <- function(nao_matched_fcst, ensemble_fcst) {
...
plot_grl2023_figS3e <- function(full_fcst, ensemble_fcst) {
...
plot_grl2023_figS3f <- function(nao_matched_fcst, ensemble_fcst) {
...
plot_grl2023_figS4a_c <- function(x) {
  rdbu_pal = RColorBrewer::brewer.pal(9, "RdBu")
  p =
    ggplot() +
    geom_sf(
